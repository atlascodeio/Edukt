...
public class NotificationsFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        URL_FEED =   getActivity().getString(R.string.url_json_getnotifications);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            swipeRefresh = new SwipeRefresh(view, (Object) this, NotificationsFragment.class.getMethod("fetchData"));
        ...
        FloatingActionButton myFab = (FloatingActionButton)  view.findViewById(R.id.add_notifications);
